...
touch "~/Movies/MOVtoMP4ConvertionScript_DO_NOT_DELETE/logs/convertMOVtoMP4_${currentDate}.log"
log="~/Movies/MOVtoMP4ConvertionScript_DO_NOT_DELETE/logs/convertMOVtoMP4_${currentDate}.log"
...
function convertFiles() {
    ...
    while [ $i -le ${#files[@]} ]
        do
            ...
            ~/Movies/MOVtoMP4ConvertionScript_DO_NOT_DELETE/ffmpeg -i ${file} -c:v h264_videotoolbox -b:v 10000k -vf yadif -pix_fmt yuv420p -c:a ac3 -b:a 1024k "${newfile}.mp4" 
